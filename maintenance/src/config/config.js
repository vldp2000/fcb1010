module.exports = {
  qqAPI_URL: process.env.VUE_APP_API_URL || 'http://192.168.17.55:8081/',
  qqmessageURL: process.env.VUE_APP_MESSAGE_URL || 'http://192.168.17.55:8081/',
  ...
  messageURL: process.env.VUE_APP_MESSAGE_URL || 'http://192.168.17.55:8081/'
}
