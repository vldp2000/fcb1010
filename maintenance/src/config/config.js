module.exports = {
  ...
  viewEditModeMessage: process.env.VUE_APP_VIEW_EDIT_MODE_MESSAGE || 'VIEW_EDIT_MODE_MESSAGE',

  controllerPresetVoluleMessage: process.env.VUE_APP_CONTROLLER_PRESET_VOLUME_MESSAGE || 'CONTROLLER_PRESET_VOLUME_MESSAGE',
