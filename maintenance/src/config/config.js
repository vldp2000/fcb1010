module.exports = {
  qAPI_URL: process.env.VUE_APP_API_URL || 'http://192.168.17.55:8081/',
  qmessageURL: process.env.VUE_APP_MESSAGE_URL || 'http://192.168.17.55:8088/',
  ...
  API_URL: process.env.VUE_APP_API_URL || 'http://192.168.17.20:8081/',
  messageURL: process.env.VUE_APP_MESSAGE_URL || 'http://192.168.17.20:8081/'
}
