module.exports = {
  _API_URL: process.env.VUE_APP_API_URL || 'http://192.168.17.55:8081/',
  _messageURL: process.env.VUE_APP_MESSAGE_URL || 'http://192.168.17.55:8088/',
  ...
  messageURL: process.env.VUE_APP_MESSAGE_URL || 'http://192.168.17.20:8088/'
}
