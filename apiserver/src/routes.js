...
module.exports = (app) => {
  ...
  app.put('/song/:id', SongController.put)
  ...
  app.put('/instrument/:id', InstrumentController.put)
  ...
  app.put('/preset/:id', PresetController.put)
